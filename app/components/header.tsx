                ...
                <div className="mt-6 flex flex-col gap-3 text-base">
                  ...
                  <div className="mt-3 flex flex-col">
                    ...
                    <a
                      ...
                      target="_blank"
                      className="mt-4 inline-flex items-center justify-center gap-2 rounded-xl border border-pink-500 px-4 py-2 text-sm font-semibold text-zinc-700"
                    >
                      Ver Instagram
                    ...
                    <a
                      ...
                      target="_blank"
                      className="mt-4 inline-flex items-center justify-center gap-2 rounded-xl border border-green-500 px-4 py-2 text-sm font-semibold text-zinc-700"
                    >
                      Ver Whatsapp
